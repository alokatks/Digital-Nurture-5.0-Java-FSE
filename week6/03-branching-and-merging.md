...
\- After `git merge`, `feature.txt` exists on the trunk and the history graph shows the merge.

\- `git branch -d` removes the branch cleanly because it has already been merged.
